package com.blogify.blogapi.endpoint.event;
...
import com.blogify.blogapi.endpoint.event.gen.UuidCreated;
import com.blogify.blogapi.repository.DummyUuidRepository;
        ...
        List.of(
            new EventConsumer.AcknowledgeableTypedEvent(
                new EventConsumer.TypedEvent(
                    "com.blogify.blogapi.endpoint.event.gen.UuidCreated", payloadReceived),
                () -> {})));
