...
public class SecurityIT {
  ...
  void signin_ok() throws ApiException {
    ...
    Whoami actual = api.signIn(new AuthenticationPayload());
  ...
  /*@Test
  void signin_ko() throws ApiException {
    ApiClient client = anApiClient(BAD_TOKEN);
    SecurityApi api = new SecurityApi(client);

    assertThrowsForbiddenException(() -> api.signIn(new AuthenticationPayload()));
  }*/
